...
<ul style="list-style-type:disc;">
	...
	<li> 2. The magitudes should be <= 1 </li>
	<li> 3. Each 'series' should have the same number of triples, this may require including a number of empty triples (, "", "", "") </li>
</ul> 
...
<ul style="list-style-type:disc;">
	...
	<li> 2. The 'Product B' line has an additional, empty triple added at the end to preserve the number of triples per series </li>
