...
\end{align}
where for simplicity in the above \(\mathbf{R} = ... \) <br><br>

Noting that the term \( c\) above is a constant independent of \(\mathbf{w} \) we have the problem stated as:
\begin{align}
...
Compare this plot to Ficture 1 <br><br>
